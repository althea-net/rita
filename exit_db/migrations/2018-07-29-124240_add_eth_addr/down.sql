...
INSERT INTO clients (mesh_ip, wg_pubkey, wg_port, luci_pass, internal_ip, email, country, email_code, verified, email_sent_time)
  SELECT mesh_ip, wg_pubkey, wg_port, luci_pass, internal_ip, email, country, email_code, verified, email_sent_time
  FROM clients_old;
