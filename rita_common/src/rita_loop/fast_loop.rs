...
use crate::payment_validator::tick_payment_validator;
        ...
        while let Err(e) = {
            thread::spawn(move || {
                ...
                runner.block_on(async move {
                    loop {
                        let payment_validator_state = PaymentValidator::new();
                        let payment_controller_state = PaymentController::new();
