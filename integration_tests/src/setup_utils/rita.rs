...
pub fn spawn_rita_exit(
    ...
    let _rita_handler = thread::spawn(move || {
        ...
        resettings.exit_network.wg_private_key = WgKey::from_str("ALxcZm2r58gY0sB4vIfnjShc86qBoVK3f32H9VrwqWU=").unwrap();
        resettings.exit_network.wg_public_key = WgKey::from_str("H/ABwzXk834OwGYU8CZGfFxNZOd+BAJEaVDHiEiWWhU=").unwrap();
