...
mod tests {
    ...
    fn new_identity(x: u8) -> Identity {
        ...
        Identity{
            ...
            wg_public_key: eui48::MacAddress::new([x; 6]),
    ...
    fn test_make_payments() {
        ...
        let _m = mock("POST", "/make_payment")
            ...
            .match_body("{\"to\":{\"mesh_ip\":\"1:1:1:1:1:1:1:1\",\"eth_address\":\"0x0101010101010101010101010101010101010101\",\"wg_public_key\":\"01-01-01-01-01-01\"},\"from\":{\"mesh_ip\":\"1:1:1:1:1:1:1:1\",\"eth_address\":\"0x0101010101010101010101010101010101010101\",\"wg_public_key\":\"01-01-01-01-01-01\"},\"amount\":\"1\"}")
            .create();
    ...
    fn test_single_payment_received() {
        ...
        let _m = mock("POST", "/update")
            .with_status(200)
            .with_body("bounty OK")
            .match_body("{\"from\":{\"mesh_ip\":\"1:1:1:1:1:1:1:1\",\"eth_address\":\"0x0101010101010101010101010101010101010101\",\"wg_public_key\":\"01-01-01-01-01-01\"},\"balance\":\"1\",\"tx\":{\"to\":{\"mesh_ip\":\"1:1:1:1:1:1:1:1\",\"eth_address\":\"0x0101010101010101010101010101010101010101\",\"wg_public_key\":\"01-01-01-01-01-01\"},\"from\":{\"mesh_ip\":\"1:1:1:1:1:1:1:1\",\"eth_address\":\"0x0101010101010101010101010101010101010101\",\"wg_public_key\":\"01-01-01-01-01-01\"},\"amount\":\"1\"}}")
            .create();
