...
2001::2 dev eth0  FAILED",
            ...
            ("wg set wg1 listen-port 8088 private-key private_key peer x8AcR9wI4t97aowYFlis077BDBk9SLdq6khMiixuTsQ= endpoint [fe80::12:34:56:78:90%eth2]:8088 allowed-ips ::/0 persistent-keepalive 5", ""),
            ("ip address add fd00::1 dev wg1", ""),
            ("ip address add fe80::1/64 dev wg1", ""),
